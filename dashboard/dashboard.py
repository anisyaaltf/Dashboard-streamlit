...
import datetime as dt
    ...
    df['order_purchase_timestamp'] = pd.to_datetime(df['order_purchase_timestamp'])        return df
    ...
    total_orders = df_filtered['order_id'].unique()
    total_customers = df_filtered['customer_id'].unique()
    ...
    with col2:
        ...
        st.line_chart(monthly_sales.set_index('month')['order'])
    ...
    snapshot_date = df_filtered['order_purchase_timestamp']
